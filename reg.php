    ...
    try
      {
            ...
            $conn = getConnection();
            $sql = "INSERT INTO FELHASZNALO (FELHASZNALO_NEV, JELSZO_HASH, EMAIL, SZULETETT, KERESZTNEV, VEZETEKNEV, NEVNAPHONAP, NEVNAPNAP) VALUES ('".$_POST["usernev"]."', '".$_POST["jelszo"]."', '".$_POST["email"]."', to_date('".$datum."','dd-mm-yy hh24:mi:ss'), '".$keresztnev."', '".$vezeteknev."', ".$nevnapho.", ".$nevnapnap.")";
            dump($sql);
            insert($conn, $sql);
            $conn = null;
        } 
